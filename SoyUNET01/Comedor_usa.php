...
<body class="blurBg-true" style="background-color:#f7f7f7">    
        <div class="main">
            <div class="container">
                <div class="row-fluid">
                    <div class="well-none">
                                    ...
                                    <div class="carousel-inner">
                                            ...
                                            <div class="row">
                                                 <div class="col-sm-12 hidden-xs">
                                                    <a href="#x col-xs-6" class="thumbnail">
                                                        <img src="images/slider-1-c.jpg" alt="Image" class="img-responsive six-din-img"></a>
                                                </div>
                                            </div>
                                            <!--/row-->
                                        </div>
                                        ...
                                        <div class="item">
                                            <div class="row">
                                                <div class="col-sm-12 hidden-xs">
                                                    <a href="#x col-xs-6" class="thumbnail">
                                                        <img src="images/slider-1-car.jpg" alt="Image" class="img-responsive"></a>
                                                </div>  
                                            </div>
                                            <!--/row-->
                                        </div>
                        ...
                        <div class="row-fluid"> 
                            <h2 class="top-1 p3" aling="center">Almuerzo</h2>
                            <div class=" ">
...
<form class="formoid-solid-dark" style="background-color:#FFFFFF;font-size:12px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:210px;min-width:150px" method="post"><div class="title"><h2>Lunes</h2></div>
    ...
    <div class="element-input"><label class="title"></label><div class="item-cont"><input class="large" type="text" name="input2" placeholder="Input Text"/><span class="icon-place"></span></div></div>
    <div class="element-input"><label class="title"></label><div class="item-cont"><input class="large" type="text" name="input3" placeholder="Input Text"/><span class="icon-place"></span></div></div>
...
<div class="submit"><input type="submit" value="Guardar"/></div></form><p class="frmd"><a href="http://formoid.com/v29.php">contact us form</a> Formoid.com 2.9</p><script type="text/javascript" src="formoid_files/formoid1/formoid-solid-dark.js"></script>
                                    </div>
                                    <div class="col-md-3 col-sm-12 col-xs-12" >
                                        <label><h3 class="top-1 p3">Martes</h3></label>
                                    </div>
                                    <div class="col-md-2 col-sm-12 col-xs-12" >
                                        <label><h3 class="top-1 p3">Miercoles</h3></label>
                                    </div>
                                    <div class="col-md-3 col-sm-12 col-xs-12" >
                                        <label><h3 class="top-1 p3" >Jueves</h3></label>
                                    </div>
                                    <div class="col-md-2 col-sm-12 col-xs-12" >
                                        <label><h3 class="top-1 p3">Viernes</h3></label>
                                    </div>
                                </form>     
                            </div>
                            <div class="col-md-2 col-sm-12 col-xs-12" >
