                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12"><?php } ?>
                            ...
                            <div class="jumbotron boxx1">
                                <form method="POST" name="Texto" id="Texto" >
                                    ...
                                    {
                                        ?>
                                        <input  name="conte1" type="submit" class="btn btn-default" value="Aceptar">
                                        <input  name="conte" type="submit" class="btn btn-default" value="Eliminar"><br>
                                        <?php
                                    }
                                    else
                                    {
                                        ?>
                                        <input  name="conte2" type="submit" class="btn btn-default" value="Volver">
                                        <?php
                                    } 
                                    mysql_close($link);?>
                                </form> 
